...
\cventry{Nov 2020 - Now}{Artificial Intelligence Analyst}{Wavy Global}{Brazil}{}{Data science, research, development, and programming.}
...
\begin{itemize}
	\item \textbf{Programming Languages:} Proficient in: C++, Python, Javascript, Node.js, HTML5, CSS3, SQL. \textit{Cloud computing:} Azure, AWS, Oracle Cloud. \textit{Basic abilities:} C\#, Java, Arduino.\vspace{2pt}
