...
\cvtext{
\begin{itemize}
	\item \textbf{Programming Languages:} Python, C++, Javascript, Node.js, SQL. 
	\textit{Cloud computing:} Microsoft Azure, AWS, Google Cloud Platform. \textit{Basic abilities:} C\#, Java, Arduino.\vspace{2pt}
