...
%-- personal data
%----------------------------------------------------------------------
\name{Leonardo Mauro Pereira}{Moraes}
\title{Curriculum Vitae} % optional
\address{São Carlos, Brazil, 13560-550}{}{} % optional
...
\cventry{2017 - 2019 \textit{(expected)}}{Master in Computer Sciences and Computational Mathematics}{University of São Paulo/Institute of Mathematics and Computer Sciences}{USP/ICMC}{Brazil}{
\textit{Data Mining, Artificial Intelligence, Recommender System, Time Series.}}

\cventry{2013 - 2017}{Bachelor in Computer Science}{University Federal of Mato Grosso do Sul/Ponta Porã}{UFMS/CPPP}{Brazil}{\textit{Artificial Intelligence, Data Stream.}}
...
%-- employment history
%----------------------------------------------------------------------
\section{Employment History} \vspace{5pt}

\cventry{Mar 2015 - Mar 2016}{Scholarship - Web Developer}{Inspectorate of the Brazilian Federal Revenue}{Brazil}{}{Analysis and development of web systems, database management, requirements analysis. I developed a Enterprise Resource Planning (ERP) web system to inventory control and activity monitoring.}

\cventry{Jan 2012 - Out 2012}{Web Developer}{FastCash}{Brazil}{}{Development of web systems for intern operations, such as CRUD operations system and activity monitoring system.}
...
\cventry{Aug 2017}{JavaScript Innovation Award}{JS Classes}{}{\href{https://www.jsclasses.org/smm-maker-profile}{https://www.jsclasses.org/smm-maker-profile}}{Super Mario Maker is a Nintendo application that allows players to create and modify levels for the well known Super Mario Bros. game. This package can retrieve the profile information of a Super Mario Maker user from the Nintendo Web site using its API.}

\cventry{Jul 2017}{Hackathon}{SEMISH/Brazilian Computer Society}{\href{http://csbc2017.mackenzie.br/eventos/44-semish}{http://csbc2017.mackenzie.br/eventos/44-semish}}{Daninha's Finder: Web system with the purpose of finding weeds in crop fields using Qualcomm DragonBoard 410C in Internet of Things scenario}{}

\cventry{Mai 2017}{JavaScript Innovation Award}{JS Classes}{}{\href{https://www.jsclasses.org/tapai}{https://www.jsclasses.org/tapai}}{Games are a way to entertain users that can also be used as means to study how people react to certain situations. This package implements a game that requires the users to interact. It records the user actions, so they can be analyzed later for further study.}
...
\cvtext{
\begin{itemize}
	\item \textbf{Programming Languages:} Proficient in: C++, Python, PHP, Javascript, Node.js, HTML5, CSS3, SQL. Also basic ability with: Java, Arduino, Matlab. \vspace{3pt}
	\item \textbf{General Business Skills:} Good presentation skills, works well in a team. \vspace{3pt}
...
{\cvreference{Anderson Alves Camargo}
    ...
    {Ponta Porã, Brazil, 79900-000}    	{anderson.camargo@receita.fazenda.gov.br}
    {}%tel
}
...
\cvdoublecolumn{
	...
	\textbf{Software Factory of UFMS/CPPP:} \textit{Development of web softwares and mobile educational softwares for Ponta Porã (2013 - 2015).}
