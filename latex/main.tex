...
\social[linkedin][www.linkedin.com/in/leonardo-mauro/]{leonardo-mauro}
...
%----------------------------------------------------------------------
\vspace*{-6pt}
\small{What do I do? I solve problems using data insights! Currently, I work as a data analyst developing intelligent reports and business intelligence for internal and external stakeholders, as well as developing data-related products, acting as a data product manager. Besides, I am studying artificial intelligence techniques and algorithms. I like to explore new technologies because \textit{"the joy of thinking and learning makes us think and learn even more." (Aristotle)}}
...
\cventry{Set 2020 - Now}{Professor Tutor}{University of Sao Paulo}{Brazil}{}{Tutor of the Master of Business Administration (MBA) of Data Science.}
...
\begin{itemize}
	\item \textbf{Programming Languages:} Proficient in: C++, Python, Javascript, Node.js, PHP, HTML5, CSS3, SQL. \textit{Cloud computing:} Azure, AWS, Oracle Cloud. \textit{Basic abilities:} C\#, Java, Arduino.\vspace{2pt}
