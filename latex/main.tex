...
\cventry{Set 2020 - Now}{Data Science Tutor}{University of Sao Paulo}{Brazil}{}{Tutor of the Master of Business Administration (MBA) of Data Science.}
...
\begin{itemize}
	\item \textbf{Programming Languages:} Proficient in: C++, Python, PHP, Javascript, Node.js, HTML5, CSS3, SQL. \textit{Cloud computing:} AWS, Azure, Oracle Cloud. \textit{Basic abilities:} Java, C\#, Arduino.\vspace{2pt}
...
{\cvreference{Alexandre Cordeiro}
    ...
    {Argo Solutions}
    {Sao Paulo, SP, Brazil}
    {alexandre.cordeiro@useargo.com}
    {}%tel
}
